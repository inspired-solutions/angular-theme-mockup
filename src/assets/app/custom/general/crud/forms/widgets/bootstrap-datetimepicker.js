var KTBootstrapDatetimepicker = {
	init: function() {
		$('#kt_datetimepicker_1').datetimepicker({ todayHighlight: !0, autoclose: !0, format: 'yyyy.mm.dd hh:ii' }),
			$('#kt_datetimepicker_1_modal').datetimepicker({ todayHighlight: !0, autoclose: !0, format: 'yyyy.mm.dd hh:ii' }),
			$(
