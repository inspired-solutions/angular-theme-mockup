		...
		init: function() {
			!(function() {
				$('#kt_datepicker').datepicker({
					...
					$('#kt_timepicker').timepicker({ minuteStep: 1, showSeconds: !0, showMeridian: !0 }),
					$('#kt_daterangepicker').daterangepicker(
						{ buttonClasses: ' btn', applyClass: 'btn-primary', cancelClass: 'btn-secondary' },
						function(t, i, a) {
				...
				$('#kt_typeahead').typeahead(null, { name: 'countries', source: t }),
