	...
	return {
		init: function() {
			...
			!(function() {
						...
						var e = Chart.helpers.color,
							a = {
								...
								datasets: [
									{
										fill: !0,
										backgroundColor: e(KTApp.getStateColor('brand'))
											.alpha(0.6)
											.rgbString(),
										borderColor: e(KTApp.getStateColor('brand'))
											.alpha(0)
											.rgbString(),
										pointHoverRadius: 4,
										pointHoverBorderWidth: 12,
				...
				(function() {
					...
					function r(t, e, a) {
						var r = '',
							o = '';
						e - t < 100 || 'Today' == a
							? ((r = 'Today:'), (o = t.format('MMM D')))
							: 'Yesterday' == a
							? ((r = 'Yesterday:'), (o = t.format('MMM D')))
							: (o = t.format('MMM D') + ' - ' + e.format('MMM D')),
							$('#kt_dashboard_daterangepicker_date').html(o),
							$('#kt_dashboard_daterangepicker_title').html(r);
					}
				})(),
								...
								template: function(t, e) {
									...
									return a > 5
										...
										: '<div class="kt-user-card-v2">\t\t\t\t\t\t\t<div class="kt-user-card-v2__pic">\t\t\t\t\t\t\t\t<div class="kt-badge kt-badge--xl kt-badge--' +
												['success', 'brand', 'danger', 'success', 'warning', 'primary', 'info'][
				...
				e.owlCarousel({ rtl: KTUtil.isRTL(), center: !0, loop: !0, items: 2 }),
				a.owlCarousel({ rtl: KTUtil.isRTL(), items: 1, animateIn: 'fadeIn(100)', loop: !0 }),
