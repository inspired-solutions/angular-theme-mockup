	...
	init: function() {
		$('#kt_blockui_1_1').click(function() {
			...
			$('#kt_blockui_1_2').click(function() {
				KTApp.block('#kt_blockui_1_content', { overlayColor: '#000000', state: 'primary' }),
					setTimeout(function() {
						KTApp.unblock('#kt_blockui_1_content');
					}, 2e3);
			}),
			$('#kt_blockui_1_3').click(function() {
				KTApp.block('#kt_blockui_1_content', { overlayColor: '#000000', type: 'v2', state: 'success', size: 'lg' }),
					setTimeout(function() {
						KTApp.unblock('#kt_blockui_1_content');
					}, 2e3);
			}),
			...
			$('#kt_blockui_2_2').click(function() {
				KTApp.block('#kt_blockui_2_portlet', { overlayColor: '#000000', state: 'primary' }),
					setTimeout(function() {
						KTApp.unblock('#kt_blockui_2_portlet');
					}, 2e3);
			}),
			$('#kt_blockui_2_3').click(function() {
				KTApp.block('#kt_blockui_2_portlet', { overlayColor: '#000000', type: 'v2', state: 'success', size: 'lg' }),
					setTimeout(function() {
						KTApp.unblock('#kt_blockui_2_portlet');
					}, 2e3);
			}),
			...
			$('#kt_blockui_3_3').click(function() {
				KTApp.blockPage({ overlayColor: '#000000', type: 'v2', state: 'success', size: 'lg' }),
					setTimeout(function() {
						KTApp.unblockPage();
					}, 2e3);
			}),
			...
			$('#kt_blockui_3_5').click(function() {
				KTApp.blockPage({ overlayColor: '#000000', type: 'v2', state: 'primary', message: 'Processing...' }),
					setTimeout(function() {
						KTApp.unblockPage();
					}, 2e3);
			}),
			...
			$('#kt_blockui_4_2').click(function() {
				KTApp.block('#kt_blockui_4_2_modal .modal-content', { overlayColor: '#000000', state: 'primary' }),
					setTimeout(function() {
