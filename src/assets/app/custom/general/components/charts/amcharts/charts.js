			...
			AmCharts.makeChart('kt_amcharts_1', {
				...
				AmCharts.makeChart('kt_amcharts_2', {
					...
					dataProvider: [
						...
						{ year: 2014, income: 34.1, expenses: 32.9, dashLengthColumn: 5, alpha: 0.2, additional: '(projection)' },
					],
				...
				AmCharts.makeChart('kt_amcharts_5', {
					...
					valueAxes: [{ minorGridAlpha: 0.08, minorGridEnabled: !0, position: 'top', axisAlpha: 0 }],
					startDuration: 1,
					graphs: [
						{
				...
				AmCharts.makeChart('kt_amcharts_10', {
					...
					startDuration: 1,
					graphs: [
						{ balloonText: '[[category]]: [[value]] m/s', bullet: 'round', fillAlphas: 0.3, valueField: 'value' },
					],
