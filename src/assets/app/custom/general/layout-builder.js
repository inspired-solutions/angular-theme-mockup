	...
	var e = {
			...
			exportHtml: function(t) {
				e.startLoad({
					...
					$.ajax('index.php', {
						method: 'POST',
						data: { builder_export: 1, export_type: 'partial', demo: t, theme: 'metronic' },
					}).done(function(t) {
						var a = JSON.parse(t);
						if (a.message) e.stopWithNotify(a.message);
						else {
							var i = setInterval(function() {
								$.ajax('index.php', { method: 'POST', data: { builder_export: 1, builder_check: a.id } }).done(function(
									t,
								) {
									var a = JSON.parse(t);
									void 0 !== a &&
			...
			exportHtmlStatic: function(t) {
				e.startLoad({
					...
					$.ajax('index.php', {
						method: 'POST',
						data: { builder_export: 1, export_type: 'html', demo: t, theme: 'metronic' },
					}).done(function(t) {
						var a = JSON.parse(t);
						if (a.message) e.stopWithNotify(a.message);
						else
				...
				$('#builder_export_angular').click(function(t) {
					...
					if (a) {
						...
						e.startLoad({
							...
							$.ajax('index.php', {
								method: 'POST',
								data: { builder_export: 1, export_type: 'angular', demo: $(i).data('demo'), purchase_code: a },
							}).done(function(t) {
								var a = JSON.parse(t);
								if (a.message) e.stopWithNotify(a.message);
								else
									var r = setInterval(function() {
										$.ajax('index.php', { method: 'POST', data: { builder_export: 1, builder_check: a.id } }).done(
											function(t) {
												var a = JSON.parse(t);
												void 0 !== a &&
													1 === a.export_status &&
			...
			runGenerate: function() {
				$.ajax('../tools/builder/cron-generate.php', { method: 'GET', data: { theme: 'metronic' } }).done(function(
					e,
				) {});
			},
		},
			...
			e.init(),
				...
				$('[name="builder_submit"]').click(function(e) {
					...
					$(t)
						...
						.find('.btn')
						.attr('disabled', !0),
						$.ajax('index.php?demo=' + $(t).data('demo'), { method: 'POST', data: $('[name]').serialize() })
							.done(function(e) {
