	...
	return {
		...
		getHighestZindex: function(t) {
			for (var e, n, i = KTUtil.get(t); i && i !== document; ) {
				if (
					('absolute' === (e = KTUtil.css(i, 'position')) || 'relative' === e || 'fixed' === e) &&
					((n = parseInt(KTUtil.css(i, 'z-index'))), !isNaN(n) && 0 !== n)
				)
					return n;
				i = i.parentNode;
			}
		...
		deepExtend: function(t) {
			...
			for (var e = 1; e < arguments.length; e++) {
				...
				if (n)
					for (var i in n)
						n.hasOwnProperty(i) && ('object' == typeof n[i] ? (t[i] = KTUtil.deepExtend(t[i], n[i])) : (t[i] = n[i]));
			}
			return t;
		},
		extend: function(t) {
			t = t || {};
			for (var e = 1; e < arguments.length; e++)
				if (arguments[e]) for (var n in arguments[e]) arguments[e].hasOwnProperty(n) && (t[n] = arguments[e][n]);
			return t;
		},
		get: function(t) {
			var e;
		...
		addClass: function(t, e) {
			if (t && void 0 !== e) {
				...
				else if (!KTUtil.hasClass(t, e)) for (i = 0; i < n.length; i++) t.className += ' ' + KTUtil.trim(n[i]);
			}
		},
		removeClass: function(t, e) {
			if (t && void 0 !== e) {
				var n = e.split(' ');
				if (t.classList) for (var i = 0; i < n.length; i++) t.classList.remove(KTUtil.trim(n[i]));
				else if (KTUtil.hasClass(t, e))
					for (i = 0; i < n.length; i++)
						t.className = t.className.replace(new RegExp('\\b' + KTUtil.trim(n[i]) + '\\b', 'g'), '');
			}
		},
		triggerCustomEvent: function(t, e, n) {
			if (window.CustomEvent) var i = new CustomEvent(e, { detail: n });
		...
		children: function(t, e, n) {
			if (t && t.childNodes) {
				for (var i = [], o = 0, r = t.childNodes.length; o < r; ++o)
					1 == t.childNodes[o].nodeType && KTUtil.matches(t.childNodes[o], e, n) && i.push(t.childNodes[o]);
				return i;
			}
		},
		...
		data: function(t) {
			return (
				(t = KTUtil.get(t)),
				{
					set: function(e, n) {
						void 0 !== t &&
							(void 0 === t.customDataTag && (KTUtilElementDataStoreID++, (t.customDataTag = KTUtilElementDataStoreID)),
							void 0 === KTUtilElementDataStore[t.customDataTag] && (KTUtilElementDataStore[t.customDataTag] = {}),
							(KTUtilElementDataStore[t.customDataTag][e] = n));
					},
					get: function(e) {
						if (void 0 !== t)
					...
					has: function(e) {
						return (
							...
							(void 0 !== t.customDataTag &&
								!(!KTUtilElementDataStore[t.customDataTag] || !KTUtilElementDataStore[t.customDataTag][e]))
						);
					},
					remove: function(e) {
		...
		outerWidth: function(t, e) {
			if (!0 === e) {
				...
				return (
					(n += parseFloat(KTUtil.css(t, 'margin-left')) + parseFloat(KTUtil.css(t, 'margin-right'))), parseFloat(n)
				);
			}
		...
		actualCss: function(t, e, n) {
			...
			if ((t = KTUtil.get(t)) instanceof HTMLElement != !1)
				return t.getAttribute('kt-hidden-' + e) && !1 !== n
					? parseFloat(t.getAttribute('kt-hidden-' + e))
					: ((o = t.style.cssText),
					  (t.style.cssText = 'position: absolute; visibility: hidden; display: block;'),
					  'width' == e ? (i = t.offsetWidth) : 'height' == e && (i = t.offsetHeight),
					  (t.style.cssText = o),
					  t.setAttribute('kt-hidden-' + e, i),
					  parseFloat(i));
		},
			...
			if ((t = KTUtil.get(t)))
				if (void 0 !== n) t.style[e] = n;
					...
					if (i && i.getComputedStyle)
						return (e = e.replace(/([A-Z])/g, '-$1').toLowerCase()), i.getComputedStyle(t, null).getPropertyValue(e);
					if (t.currentStyle)
						return (
		...
		slide: function(t, e, n, i, o) {
			if (!(!t || ('up' == e && !1 === KTUtil.visible(t)) || ('down' == e && !0 === KTUtil.visible(t)))) {
				...
				KTUtil.css(t, 'padding-top') &&
					...
					KTUtil.data(t).has('slide-padding-top') && (a = parseInt(KTUtil.data(t).get('slide-padding-top'))),
					KTUtil.data(t).has('slide-padding-bottom') && (l = parseInt(KTUtil.data(t).get('slide-padding-bottom'))),
					'up' == e
		...
		off: function(t, e, n) {
			t &&
				KTUtilDelegatedEventHandlers[n] &&
				(KTUtil.removeEvent(t, e, KTUtilDelegatedEventHandlers[n]), delete KTUtilDelegatedEventHandlers[n]);
		},
		one: function(t, e, n) {
		...
		animateDelay: function(t, e) {
			for (var n = ['webkit-', 'moz-', 'ms-', 'o-', ''], i = 0; i < n.length; i++)
				KTUtil.css(t, n[i] + 'animation-delay', e);
		},
		animateDuration: function(t, e) {
			for (var n = ['webkit-', 'moz-', 'ms-', 'o-', ''], i = 0; i < n.length; i++)
				KTUtil.css(t, n[i] + 'animation-duration', e);
		},
		scrollTo: function(t, e, n) {
			n = n || 500;
			var i,
				o,
				r = (t = KTUtil.get(t)) ? KTUtil.offset(t).top : 0,
				a = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0;
			r > a ? ((i = r), (o = a)) : ((i = a), (o = r)),
				e && (o += e),
				KTUtil.animate(i, o, n, function(t) {
		...
		numberString: function(t) {
			for (var e = (t += '').split('.'), n = e[0], i = e.length > 1 ? '.' + e[1] : '', o = /(\d+)(\d{3})/; o.test(n); )
				n = n.replace(o, '$1,$2');
			return n + i;
		},
		detectIE: function() {
		...
		scrollInit: function(t, e) {
			function n() {
				var n, i;
				(i = e.height instanceof Function ? parseInt(e.height.call()) : parseInt(e.height)),
					e.disableForMobile && KTUtil.isInResponsiveRange('tablet-and-mobile')
						? (n = KTUtil.data(t).get('ps'))
							? (e.resetHeightOnDestroy
									? KTUtil.css(t, 'height', 'auto')
									: (KTUtil.css(t, 'overflow', 'auto'), i > 0 && KTUtil.css(t, 'height', i + 'px')),
							  n.destroy(),
							  (n = KTUtil.data(t).remove('ps')))
							: i > 0 && (KTUtil.css(t, 'overflow', 'auto'), KTUtil.css(t, 'height', i + 'px'))
						: (i > 0 && KTUtil.css(t, 'height', i + 'px'),
...
var KTHeader = function(t, e) {
		var n = this,
			...
			o = KTUtil.get('body');
		if (void 0 !== i) {
			var r = { classic: !1, offset: { mobile: 150, desktop: 200 }, minimize: { mobile: !1, desktop: !1 } },
				a = {
					construct: function(t) {
						return (
							KTUtil.data(i).has('header')
								? (n = KTUtil.data(i).get('header'))
								: (a.init(t), a.build(), KTUtil.data(i).set('header', n)),
							n
						);
					},
					init: function(t) {
						...
						(!1 === n.options.minimize.mobile && !1 === n.options.minimize.desktop) ||
							window.addEventListener('scroll', function() {
								...
								KTUtil.isInResponsiveRange('desktop')
									? ((s = n.options.offset.desktop),
									  (i = n.options.minimize.desktop.on),
									  (r = n.options.minimize.desktop.off))
									: KTUtil.isInResponsiveRange('tablet-and-mobile') &&
									  ((s = n.options.offset.mobile),
									  (i = n.options.minimize.mobile.on),
									  (r = n.options.minimize.mobile.off)),
									(l = window.pageYOffset),
									(KTUtil.isInResponsiveRange('tablet-and-mobile') && n.options.classic && n.options.classic.mobile) ||
									(KTUtil.isInResponsiveRange('desktop') && n.options.classic && n.options.classic.desktop)
										? l > s
											? (KTUtil.addClass(o, i),
											  KTUtil.removeClass(o, r),
											  e && (a.eventTrigger('minimizeOn', n), (e = !1)))
											: (KTUtil.addClass(o, r),
											  KTUtil.removeClass(o, i),
											  0 == e && (a.eventTrigger('minimizeOff', n), (e = !0)))
										: (l > s && t < l
												? (KTUtil.addClass(o, i),
												  KTUtil.removeClass(o, r),
												  e && (a.eventTrigger('minimizeOn', n), (e = !1)))
					...
					eventTrigger: function(t, e) {
						for (var i = 0; i < n.events.length; i++) {
							...
							o.name == t &&
								(1 == o.one
									? 0 == o.fired && ((n.events[i].fired = !0), o.handler.call(this, n, e))
									: o.handler.call(this, n, e));
						}
					},
				...
				l = {
					construct: function(t) {
						return (
							KTUtil.data(o).has('menu')
								? (n = KTUtil.data(o).get('menu'))
								: (l.init(t), l.reset(), l.build(), KTUtil.data(o).set('menu', n)),
							n
						);
					},
					init: function(t) {
						(n.events = []),
							(n.eventHandlers = {}),
							(n.options = KTUtil.deepExtend({}, a, t)),
					...
					update: function(t) {
						(n.options = KTUtil.deepExtend({}, a, t)),
							...
							(n.eventHandlers = {}),
							l.build(),
							KTUtil.data(o).set('menu', n);
					},
					reload: function() {
						l.reset(), l.build(), l.resetSubmenuProps();
					},
					build: function() {
						(n.eventHandlers.event_1 = KTUtil.on(o, '.kt-menu__toggle', 'click', l.handleSubmenuAccordion)),
							('dropdown' === l.getSubmenuMode() || l.isConditionalSubmenuDropdown()) &&
					...
					reset: function() {
						KTUtil.off(o, 'click', n.eventHandlers.event_1),
							KTUtil.off(o, 'mouseover', n.eventHandlers.event_2),
							KTUtil.off(o, 'mouseout', n.eventHandlers.event_3),
							KTUtil.off(o, 'click', n.eventHandlers.event_4),
							KTUtil.off(o, 'click', n.eventHandlers.event_5),
					...
					getSubmenuMode: function(t) {
						return KTUtil.isInResponsiveRange('desktop')
							? t && KTUtil.hasAttr(t, 'data-ktmenu-submenu-toggle')
								...
								? KTUtil.hasClasses(r, n.options.submenu.desktop.state.body)
								...
								: void 0
							: KTUtil.isInResponsiveRange('tablet') && KTUtil.isset(n.options.submenu, 'tablet')
							? n.options.submenu.tablet
							: !(!KTUtil.isInResponsiveRange('mobile') || !KTUtil.isset(n.options.submenu, 'mobile')) &&
						...
						if ('accordion' !== l.getSubmenuMode(this)) {
							...
							'accordion' != e.getAttribute('data-ktmenu-submenu-mode') &&
								(!1 === KTUtil.hasClass(e, 'kt-menu__item--hover')
									? (KTUtil.addClass(e, 'kt-menu__item--open-dropdown'), l.showSubmenuDropdown(e))
									: (KTUtil.removeClass(e, 'kt-menu__item--open-dropdown'), l.hideSubmenuDropdown(e, !0)),
								t.preventDefault());
						}
					},
					...
					handleSubmenuDropdownClose: function(t, e) {
						if ('accordion' !== l.getSubmenuMode(e)) {
							...
							if (
								...
								for (var i = 0, r = n.length; i < r; i++) l.hideSubmenuDropdown(n[0], !0);
						}
					},
					handleSubmenuAccordion: function(t, e) {
						var i,
							o = e || this;
						if (
							'dropdown' === l.getSubmenuMode(e) &&
							(i = o.closest('.kt-menu__item')) &&
							'accordion' != i.getAttribute('data-ktmenu-submenu-mode')
						)
							t.preventDefault();
						else {
							var r = o.closest('.kt-menu__item'),
								a = KTUtil.child(r, '.kt-menu__submenu, .kt-menu__inner');
					...
					scrollToItem: function(t) {
						KTUtil.isInResponsiveRange('desktop') &&
							...
							KTUtil.scrollTo(t, n.options.accordion.autoScrollSpeed);
					},
					hideSubmenuDropdown: function(t, e) {
						e && (KTUtil.removeClass(t, 'kt-menu__item--hover'), KTUtil.removeClass(t, 'kt-menu__item--active-tab')),
							...
							t.getAttribute('data-ktmenu-dropdown-toggle-class') &&
								KTUtil.removeClass(r, t.getAttribute('data-ktmenu-dropdown-toggle-class'));
					...
					showSubmenuDropdown: function(t) {
						...
						KTUtil.addClass(t, 'kt-menu__item--hover'),
							t.getAttribute('data-ktmenu-dropdown-toggle-class') &&
								KTUtil.addClass(r, t.getAttribute('data-ktmenu-dropdown-toggle-class'));
					},
					createSubmenuDropdownClickDropoff: function(t) {
						var e,
							n = (e = KTUtil.child(t, '.kt-menu__submenu') ? KTUtil.css(e, 'z-index') : 0) - 1,
						...
						r.appendChild(i),
							KTUtil.addEvent(i, 'click', function(e) {
					...
					resetActiveItem: function(t) {
						...
						if (!1 === n.options.accordion.expandAll && (e = o.querySelectorAll('.kt-menu__item--open')))
							for (r = 0, a = e.length; r < a; r++) KTUtil.removeClass(i[0], 'kt-menu__item--open');
					},
					setActiveItem: function(t) {
						l.resetActiveItem(), KTUtil.addClass(t, 'kt-menu__item--active');
						for (var e = KTUtil.parents(t, '.kt-menu__item--submenu'), n = 0, i = e.length; n < i; n++)
							KTUtil.addClass(e[n], 'kt-menu__item--open');
					},
			...
			if (o) {
				...
				if (t.target !== o && !1 === o.contains(t.target))
					if (
						...
						for (var l = 0, s = r.length; l < s; l++) a.hideDropdown(r[l]);
			}
		}
});
var KTOffcanvas = function(t, e) {
		...
		if (i) {
			var r = {},
				a = {
					construct: function(t) {
						return (
							KTUtil.data(i).has('offcanvas')
								? (n = KTUtil.data(i).get('offcanvas'))
								: (a.init(t), a.build(), KTUtil.data(i).set('offcanvas', n)),
							n
						);
					},
					init: function(t) {
						(n.events = []),
							...
							(n.state = KTUtil.hasClass(i, n.classShown) ? 'shown' : 'hidden');
					},
					build: function() {
						if (n.options.toggleBy)
							if ('string' == typeof n.options.toggleBy)
								KTUtil.addEvent(n.options.toggleBy, 'click', function(t) {
									t.preventDefault(), a.toggle();
								});
							else if (n.options.toggleBy && n.options.toggleBy[0] && n.options.toggleBy[0].target)
								for (var t in n.options.toggleBy)
									KTUtil.addEvent(n.options.toggleBy[t].target, 'click', function(t) {
										t.preventDefault(), a.toggle();
									});
							else
								n.options.toggleBy &&
									n.options.toggleBy.target &&
									KTUtil.addEvent(n.options.toggleBy.target, 'click', function(t) {
										t.preventDefault(), a.toggle();
									});
					...
					show: function(t) {
						'shown' != n.state &&
							(a.eventTrigger('beforeShow'),
							a.togglerClass(t, 'show'),
							KTUtil.addClass(o, n.classShown),
							KTUtil.addClass(i, n.classShown),
							(n.state = 'shown'),
							n.options.overlay &&
								((n.overlay = KTUtil.insertAfter(document.createElement('DIV'), i)),
								KTUtil.addClass(n.overlay, n.classOverlay),
					...
					hide: function(t) {
						'hidden' != n.state &&
							(a.eventTrigger('beforeHide'),
							a.togglerClass(t, 'hide'),
							KTUtil.removeClass(o, n.classShown),
							KTUtil.removeClass(i, n.classShown),
							(n.state = 'hidden'),
							n.options.overlay && n.overlay && KTUtil.remove(n.overlay),
					...
					togglerClass: function(t, e) {
						...
						if (n.options.toggleBy && n.options.toggleBy[0] && n.options.toggleBy[0].target)
							for (var r in n.options.toggleBy) n.options.toggleBy[r].target === o && (i = n.options.toggleBy[r]);
	...
	KTScrolltop = function(t, e) {
		var n = this,
			...
			o = KTUtil.get('body');
		if (i) {
			var r = { offset: 300, speed: 600, toggleClass: 'kt-scrolltop--on' },
				a = {
					construct: function(t) {
						return (
							KTUtil.data(i).has('scrolltop')
								? (n = KTUtil.data(i).get('scrolltop'))
								: (a.init(t), a.build(), KTUtil.data(i).set('scrolltop', n)),
							n
						);
					},
					init: function(t) {
					...
					handle: function() {
						window.pageYOffset > n.options.offset
							? KTUtil.addClass(o, n.options.toggleClass)
							: KTUtil.removeClass(o, n.options.toggleClass);
					},
					scroll: function(t) {
				...
				r = {
					...
					init: function(t) {
						(n.element = i),
							...
							(n.target = KTUtil.get(n.options.target)),
							(n.targetState = n.options.targetState),
							(n.togglerState = n.options.togglerState),
							(n.state = KTUtil.hasClasses(n.target, n.targetState) ? 'on' : 'off');
					},
					build: function() {
					...
					toggleOn: function() {
						return (
							...
							n.togglerState && KTUtil.addClass(i, n.togglerState),
							(n.state = 'on'),
					...
					toggleOff: function() {
						return (
							...
							n.togglerState && KTUtil.removeClass(i, n.togglerState),
							(n.state = 'off'),
					...
					eventTrigger: function(t) {
						for (var e = 0; e < n.events.length; e++) {
							...
							i.name == t &&
								(1 == i.one
									? 0 == i.fired && ((n.events[e].fired = !0), i.handler.call(this, n))
			...
			r = {
				...
				show: function() {
					return (
						...
						KTUtil.addClass(e, 'kt-dialog--' + n.options.state),
						KTUtil.addClass(e, 'kt-dialog--' + n.options.type),
						'top center' == n.options.placement && KTUtil.addClass(e, 'kt-dialog--top-center'),
						i.appendChild(e),
						(n.state = 'shown'),
						r.eventTrigger('shown'),
						n
					);
				},
				hide: function() {
